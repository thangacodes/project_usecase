...
echo "alias tffmt='terraform fmt --recursive'" >> ~/.bashrc
echo "alias tfvalidate='terraform validate'" >> ~/.bashrc
echo "alias tfplan='terraform plan'" >> ~/.bashrc
echo "alias tfapply='terraform apply --auto-approve'" >> ~/.bashrc
echo "alias tfdestroy='terraform destroy --auto-approve'" >> ~/.bashrc
